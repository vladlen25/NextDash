...
export const BrowserProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const createBrowser = (browser: BrowserInterface) => setBrowsers([...browsers, browser]);
    ...
    return (
        <BrowserContext.Provider value={{ browsers, createBrowser, updateBrowser, deleteBrowser }}>
            {children}
